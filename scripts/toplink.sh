...
for CROSS in BW-Combo1 BW-Combo2 BW-Combo3 BW-Combo4 BW-Combo5 FW-Combo1 FW-Combo2 FW-Combo3 FW-Combo4 FW-Combo5 ; do
	...
	# output ped
	## also parse down to ld thinned and parent vs offspring sets

	#~/bin/plink --file ${CROSS} --extract all.ld.prune.in --recode \
	#--allow-extra-chr \
	#--out ${CROSS}.thinned
