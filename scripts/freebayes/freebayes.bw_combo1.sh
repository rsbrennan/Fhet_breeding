#!/bin/bash -l
#SBATCH -J array_job
#SBATCH -o /home/rsbrenna/breeding/slurm-log/array/bw1/array_job_out_%A_%a.txt
#SBATCH -e /home/rsbrenna/breeding/slurm-log/array/bw1/array_job_err_%A_%a.txt
...
#scaf=$(cat ~/breeding/scripts/freebayes/scaffold.redo.bw1 | awk 'NR=='$SLURM_ARRAY_TASK_ID'')
echo $scaf

outfile=$scaf.vcf

#generate bam list
#find ~/breeding/processed_data/aligned/all -type f | grep "$pop" | grep -v '.bai' > ~/breeding/scripts/freebayes/$pop.list
