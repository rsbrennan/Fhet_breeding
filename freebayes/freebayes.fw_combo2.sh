#!/bin/bash -l
#SBATCH -J array_job
#SBATCH -o /home/rsbrenna/breeding/slurm-log/array/fw2/array_job_out_%A_%a.txt
#SBATCH -e /home/rsbrenna/breeding/slurm-log/array/fw2/array_job_err_%A_%a.txt
...
#scaf=$(cat ~/breeding/scripts/freebayes/scaffold.redo.fw2 | awk 'NR=='$SLURM_ARRAY_TASK_ID'')
echo $scaf
